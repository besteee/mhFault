...
<!-- mhFault&besteee.com -->
<li class="explode" key="mhFault" name="menu">猛虎故障管理
	<ul>
		<li class="menu-item"><a href="mhFault.php" target="main-frame">故障项目</a></li>
		<li class="menu-item"><a href="mhFault.php?act=diy" target="main-frame">客户提交</a></li>
	</ul>
	
</li>
<!-- mhFault&besteee.com end-->
