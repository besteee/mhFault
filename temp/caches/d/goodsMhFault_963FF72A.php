...
<title>宝马530严重烧机油（9年车龄）项目套餐_故障套餐_猛虎故障自诊断平台</title>
...
<div class="block box">
 <div id="ur_here">
  当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=174">故障套餐</a> <code>&gt;</code> 宝马530严重烧机油（9年车龄）项目套餐 </div>
</div>
...
<div class="block clearfix">
   ...
   <div id="goodsInfo" class="clearfix">
    <div class="imgInfo">
         <a href="images/201411/goods_img/292_P_1417122670552.jpg" id="Zoomer" class="MagicZoomPlus" rel="selectors-effect:false;zoom-fade:true;background-opacity:70;zoom-width:350;zoom-height:350;caption-source:img:title;thumb-change:mouseover" title="">
    <img id="img_url" name="goods_img" src="images/201411/goods_img/292_P_1417122670552.jpg" alt="宝马530严重烧机油（9年车龄）项目套餐" class="thumb" />
    </a>
         <div class="blank5"></div>
...
<ul>
<li>
<a href="images/201411/goods_img/292_P_1417122670552.jpg" rel="zoom-id:Zoomer" rev="images/201411/goods_img/292_P_1417122670552.jpg" title="">
<img src="images/201411/thumb_img/292_thumb_P_1417122670555.jpg" alt="宝马530严重烧机油（9年车龄）项目套餐" class="onbg"  onmouseover="chkimgcss(this)"/>
</a>
</li>
 </ul>
</div>
...
function clickRight(){var A=isStop;dir=0;speed=25;isStop=0;if(A){setTimeout(s,speed)}};
         ...
         <div class="blank5"></div>
		<div class="zoompic"><a href="javascript:;" onclick="window.open('gallery.php?id=292'); return false;" target="_blank"><img src="themes/jd2013/images/zoompic.gif" alt="放大图片" /></a></div>
	 <div class="sharebg">
...
document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000)
     ...
     <div class="textInfo">
     <form action="javascript:addToCart(292)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
	 <div class="ntitle">宝马530严重烧机油（9年车龄）项目套餐 </div>
	   <div class="info">
	  <ul>
	   <li class="clearfix">
              商品货号：ECS000292             </li>
	  <li class="clearfix">
       本店售价：<font class="shopprice" id="ECS_SHOPPRICE">￥31315.0 </font>       </li>
	   <li class="hpj clearfix">
       <div class="f_l onpf">用户评价：<img src="themes/jd2013/images/stars5.gif" alt="comment rank 5" /> <a href="#pj" style="color:#085C9B;">(已经有554fcae493e564ee0dc75bdf2ebf94capl_sum|a:2:{s:4:"name";s:6:"pl_sum";s:8:"goods_id";s:3:"292";}554fcae493e564ee0dc75bdf2ebf94ca人评价)</a></div>
 </li>
            <li class="clearfix">
      商品品牌：<a href="brand.php?id=36" >宝马</a>
      </li>
                 <li class="clearfix">
              注册用户：<font id="ECS_RANKPRICE_1">￥31315.0</font>&nbsp;&nbsp;&nbsp;&nbsp;
             </li>
...
function promptinfo()
{
	...
	address.value = s1.value + s2.value + s3.value;
      ...
      <div class="textInpadd clearfix">
	  <div class="f_l tmig"><a href="javascript:addToCart(292)"><img src="themes/jd2013/images/bnt_cat1.gif" /></a></div><div class="f_l fmig"><a href="javascript:collect(292)"><img src="themes/jd2013/images/bnt_colles.gif" /></a></div>
      </div>
	  </div>
      </form>
   </div>
	  ...
	  <div class="h3goods">
			<div id="com_b" class="history clearfix">
				...
				<h2 class="h2bg">售后保障</h2>
								<div class="f_r lirbuy"><a href="javascript:addToCart(292)"><img src="themes/jd2013/images/rbuy.gif" /></a></div>
			</div>
		</div>
		</div>
		<script type="text/javascript">
      ...
      <div id="com_h">
       <blockquote>
	   	<ul class="detail-list">
					<li title="宝马530严重烧机油（9年车龄）项目套餐">商品名称：宝马530严重烧机油（9年车龄）项目套餐</li>
					<li>商品编号：ECS000292</li>
					<li>品牌：<a href="brand.php?id=36" target="_blank">宝马</a></li>
					<li>上架时间：2014-11-28</li>
					<li>商品毛重：0克</li>
		         		 				<li>润滑系统故障(烧机油)：严重烧机油</li>
		         				</ul>
...
<tr><td class="topName" id="topNameTitle" colspan="4" >宝马530严重烧机油（9年车龄）项目套餐</td></tr>
	<tr class="mhFD">
		<td class="mhFaultD">合计</td>
		<td  class="subMhFd">
			<table class="subMhFdT"><tr>
				<td width="30%">总计：￥31315.00元</td>
				<td class="matePrice">￥ 0 元</td>
				<td class="timePrice">￥ 0 元</td>
				<td class="materialsPrice">￥ 0 元</td>
			</tr></table>
		</td>
	</tr>
</table>
...
for(i in mate){
	...
	$(".materialsPrice").eq(i).html(materials[i]);
        ...
        <p><img alt="" width="636" height="777" src="/images/upload/Image/11(1).jpg" /></p>
<p><img alt="" width="634" height="550" src="/images/upload/Image/12.png" /></p>       </blockquote>
	    <blockquote>
 <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#dddddd">
          ...
          <th colspan="2" bgcolor="#FFFFFF">商品属性</th>
                ...
                <tr>
          <td bgcolor="#FFFFFF" align="left" width="30%" class="f1">[润滑系统故障(烧机油)]</td>
          <td bgcolor="#FFFFFF" align="left" width="70%">严重烧机油</td>
        </tr>
                      </table>
       </blockquote>
     <blockquote>
	 <div class="blank"></div>
     <div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:292;}554fcae493e564ee0dc75bdf2ebf94ca</div>
     </blockquote>
     <blockquote>
     </blockquote>
...
<div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:292;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 <div id="ECS_COMMENTZX"> 554fcae493e564ee0dc75bdf2ebf94cazxcomments|a:3:{s:4:"name";s:10:"zxcomments";s:4:"type";i:0;s:2:"id";i:292;}554fcae493e564ee0dc75bdf2ebf94ca</div>
</div>
</div>
</div>
<div class="blank"></div>
