 ...
 */
$alipay_config['partner']		= $_GET['alipay_partner'];
$alipay_config['key']			= $_GET['alipay_key'];
...
//服务器异步通知页面路径
$notify_url = "http://".$_SERVER['SERVER_NAME']."/mobile/alipay/notify_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url = "http://".$_SERVER['SERVER_NAME']."/mobile/alipay/call_back_url.php";
//需http://格式的完整路径，不允许加?id=123这类自定义参数
